...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Aurbin355")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1002357333205"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Aurbin966/Kid-karepoamit",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/aurbinmusicbot_channel")
